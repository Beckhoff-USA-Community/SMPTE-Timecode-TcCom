...
class CSMPTE_TimecodeCtrl : public ITcOCFCtrlImpl<CSMPTE_TimecodeCtrl, CSMPTE_TimecodeClassFactory>
{
public:
	CSMPTE_TimecodeCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("SMPTE_Timecode: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CSMPTE_TimecodeCtrl>;
